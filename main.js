// Creación del módulo
let angularRoutingApp = angular.module("miApp", ["ngRoute"]);
...
angularRoutingApp.config(function ($routeProvider) {
    ...
    .when('/1', {
        ...
        controller: 'juegoDeEnderController'
    })
    .when('/2', {
        templateUrl: 'views/ficha.html',
        controller: 'juegoDeTronosController'
    })
    .when('/3', {
        templateUrl: 'views/ficha.html',
